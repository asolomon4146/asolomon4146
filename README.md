...
-   **Learnewable MCP** - Supported by all modern AI agents. Allows developers to connect your AI agent into the Learnewable platform.

<img width="395.25" height="333" alt="image" src="https://github.com/user-attachments/assets/9e148f3e-e1ba-4b96-81d9-c0b7c236ea42" />

------------------------------------------------------------------------

I also built a community sourced map of bathrooms closest to you called OpenPrivy.com. I'm a big believer in accessibility and want to build a better society. Feel free to add a privy to your area.
